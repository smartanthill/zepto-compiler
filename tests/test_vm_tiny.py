...
def test_js_tiny_2():
    ...
    out = ['/* target vm: Tiny */',
           ...
           '|JMPIFREPLYFIELD_LT|0|{INT}|420|(+14):end_6:|',
           '/* begin_2: */',
           '|MCUSLEEP|300|0|',
           '|POPREPLIES|0|',
           '|EXEC|1|0|[]|',
           ...
           '|JMPIFREPLYFIELD_LT|0|{INT}|361|(+40):end_12:|',
           '|JMPIFREPLYFIELD_GT|0|{INT}|399|(+31):end_12:|',
           '/* begin_6: */',
           '|EXEC|1|0|[]|',
           '/* if( temp2.Temperature>38.0 ) */',
           '|JMPIFREPLYFIELD_LT|1|{INT}|381|(+8):end_10:|',
           '/* begin_9: */',
           '|MOVEREPLYTOFRONT|1|',
           '|POPREPLIES|1|',
           '|EXIT|ISFIRST|',
...
def test_js_tiny_3():
    ...
    out = [
        ...
        '|EXEC|1|0|[]|',
        '/* if( c.Temperature>38 ) */',
        '|JMPIFREPLYFIELD_LT|2|{INT}|381|(+30):end_6:|',
        '/* begin_5: */',
        '|MOVEREPLYTOFRONT|3|',
        '|MOVEREPLYTOFRONT|2|',
        '|POPREPLIES|2|',
